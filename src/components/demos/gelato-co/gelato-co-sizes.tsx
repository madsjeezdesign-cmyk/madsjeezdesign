  ...
  return (
    <section id="menu" className="scroll-mt-16 bg-white py-10 sm:py-14">
      <div className="mx-auto max-w-6xl px-3 sm:px-4">
        <p className="text-[10px] font-semibold uppercase tracking-[0.35em] text-stone-400">Paso 1</p>
            ...
            >
              ...
              <div className="p-4">
                ...
                <button
                  ...
                  className="mt-4 w-full rounded-full border-2 border-stone-900 py-3.5 text-xs font-bold uppercase tracking-wider text-stone-900 transition hover:bg-stone-900 hover:text-white active:scale-[0.98]"
                >
                  Elegir gustos
                </button>
              </div>
