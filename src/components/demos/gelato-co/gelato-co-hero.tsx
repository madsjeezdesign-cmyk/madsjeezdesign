    ...
    <section id="inicio" className="relative overflow-hidden bg-stone-50">
      <div className="relative min-h-[55vh] sm:min-h-[60vh]">
        ...
        <div className="relative z-10 mx-auto flex min-h-[55vh] max-w-6xl flex-col justify-center px-3 py-16 sm:min-h-[60vh] sm:px-4">
          <p className="text-[10px] font-semibold uppercase tracking-[0.35em] text-rose-400">Artesanal · fresco</p>
          ...
          <button
            ...
            className="mt-8 w-full max-w-xs rounded-full bg-rose-400 px-8 py-4 text-sm font-bold uppercase tracking-wider text-white shadow-lg shadow-rose-200/50 transition hover:bg-rose-500 sm:w-auto"
          >
            ¡Pedir mi helado!
          </button>
        </div>
