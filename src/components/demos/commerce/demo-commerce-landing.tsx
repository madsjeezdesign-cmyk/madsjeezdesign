          ...
          <div className="relative">
            <div className="relative aspect-[4/3] overflow-hidden rounded-2xl border border-white/10">
              ...
              <div className="cm-glass absolute bottom-4 left-4 right-4 flex items-center justify-between rounded-xl p-4 md:bottom-6 md:left-6 md:right-6 md:p-5">
                <div>
                  <p className="text-[9px] uppercase tracking-widest text-slate-500">Estado del local</p>
            ...
            <div className="absolute -right-4 -top-4 hidden rounded-xl border border-white/10 bg-[#0c0c12] p-4 md:block">
              ...
              <p className="text-[9px] uppercase tracking-widest text-slate-500">Clientes felices</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-10">
          ...
          <div className="flex flex-wrap gap-3">
            {config.payments.map((tool) => (
              <span
                key={tool}
                className="rounded-lg border border-white/10 px-4 py-2 text-[10px] font-bold uppercase tracking-widest text-slate-400 transition-colors hover:border-[color:var(--cm-accent)] hover:text-white"
              >
                {tool}
              </span>
            ))}
      ...
      <section className="cm-scroll-reveal mx-4 mb-20 md:mx-10">
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl font-black uppercase tracking-wider">Atención al cliente</h3>
