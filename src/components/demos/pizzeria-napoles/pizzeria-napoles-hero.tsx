  ...
  return (
    <section id="inicio" className="relative min-h-[72vh] overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex min-h-[72vh] max-w-6xl flex-col justify-end px-3 pb-14 pt-20 sm:px-4">
        <p className="inline-flex w-fit items-center gap-2 text-[10px] font-bold uppercase tracking-[0.04em] text-red-400">
          <span className="live-ping-dot" aria-hidden />
          Masa madre · horno de barro
        </p>
        ...
        <MagneticButton
          ...
          variant="primary"
          strength={6}
          className="pn-cta-shine mt-8 w-full max-w-xs justify-center !rounded-xl !bg-red-600 !py-4 !text-sm !font-bold !uppercase !tracking-[0.04em] !text-white shadow-lg shadow-red-900/40 hover:!bg-red-500 sm:w-auto sm:!px-10"
        >
          Ver menú y pedir
        </MagneticButton>
      </div>
