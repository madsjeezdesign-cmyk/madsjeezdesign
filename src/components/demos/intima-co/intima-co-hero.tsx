    ...
    <section id="inicio" className="relative overflow-hidden bg-stone-50">
      <div className="relative min-h-[58vh] sm:min-h-[65vh]">
        ...
        <div className="relative z-10 mx-auto flex min-h-[58vh] max-w-7xl flex-col justify-center px-3 py-16 sm:min-h-[65vh] sm:px-4">
          <p className="text-[10px] font-light uppercase tracking-[0.04em] text-rose-400/90">Minimal luxury</p>
          ...
          <button
            type="button"
            onClick={onCta}
            className="mt-10 w-full max-w-xs rounded-full bg-stone-900 px-8 py-4 text-xs font-light uppercase tracking-[0.04em] text-stone-50 transition hover:bg-stone-800 sm:w-auto"
          >
            Ver colecciones
          </button>
        </div>
