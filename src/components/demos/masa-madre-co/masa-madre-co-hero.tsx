      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(92vh-4rem)] max-w-7xl flex-col justify-end px-4 pb-16 pt-24 sm:px-6 sm:pb-20">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <button
            type="button"
            onClick={() => scroll("#menu")}
            className="rounded-full bg-orange-700 px-8 py-3.5 text-xs font-black uppercase tracking-[0.04em] text-white shadow-lg shadow-orange-300/40 transition hover:bg-orange-800"
          >
            Hacer pedido
          </button>
          <button
            type="button"
            onClick={() => scroll("#menu")}
            className="rounded-full border-2 border-stone-800/20 bg-white/90 px-8 py-3.5 text-xs font-black uppercase tracking-[0.04em] text-stone-800 backdrop-blur transition hover:border-orange-400"
          >
            Ver menú del día
          </button>
        </div>
        <button
          ...
          className="mt-12 flex items-center gap-2 text-xs font-bold uppercase tracking-[0.04em] text-stone-600"
