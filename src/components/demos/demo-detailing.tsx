  ...
  return (
    <div style={demoBodyStyle(SLUG)} className={art.pageRoot}>
      ...
      <DemoThemedHero
        ...
        kicker={<p className={`text-[10px] uppercase tracking-[0.35em] text-sky-400 ${h}`}>Cerámica · PPF · interior</p>}
        title={
          <>
            Detailing
            <br />
        ...
        lead="Lavado químico, descontaminación férrica, corrección de barniz con pulidora rotativa/orbital, sellado cerámico y PPF parcial en puntos calientes demo. Box climatizado, luz CRI 95 y checklist fotográfico antes / después. Pickup & drop para ejecutivos con seguro de llave."
        ctas={
          <>
            <button type="button" className={art.primaryCta}>
              Cotizar full
      ...
      <DemoStatsStrip
        ...
        sectionClass="border-y border-slate-800 bg-[#0b0f14]"
        labelClass="mt-2 text-[11px] uppercase tracking-wider text-slate-500"
      />
      ...
      <section className="flex flex-wrap items-center justify-center gap-3 bg-sky-600 px-4 py-10">
        <Sparkles className="h-8 w-8 text-white" />
        <Car className="h-8 w-8 text-white" />
        <p className={`text-center font-bold text-white ${h}`}>Combo cerámica + interior 15% off demo · junio</p>
      </section>
