    ...
    <section id="inicio" className="relative overflow-hidden bg-stone-100">
      <div className="relative min-h-[56vh] sm:min-h-[62vh]">
        ...
        <div className="relative z-10 mx-auto flex min-h-[56vh] max-w-7xl flex-col justify-center px-3 py-16 sm:min-h-[62vh] sm:px-4">
          <p className="text-[10px] font-medium uppercase tracking-[0.4em] text-amber-800">Artesanía · campo · identidad</p>
          ...
          <button
            ...
            className="mt-8 w-full max-w-xs rounded-full bg-amber-800 px-8 py-4 text-xs font-semibold uppercase tracking-[0.2em] text-amber-50 shadow-lg shadow-amber-900/20 transition hover:bg-orange-900 sm:w-auto"
          >
