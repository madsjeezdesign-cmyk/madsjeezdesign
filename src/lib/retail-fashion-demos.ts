...
const AW = {
  hero: img("photo-1774691799598-71e688b1bf7f", 2000),
  coat: img("photo-1763824969015-e5d1d6755782"),
  knit: img("photo-1760287363707-851f4780b98c"),
  blazer: img("photo-1773864931052-ea56474bcc84"),
  dress: img("photo-1774571872279-59580ca46d45"),
  pants: img("photo-1753161021164-b075e15e91b3"),
  leather: img("photo-1636023329674-7b7ea3c663e9"),
  boots: img("photo-1763771444851-4fa902534f04"),
  scarf: img("photo-1762796876250-2ea2c4078f52"),
  editorial: img("photo-1758274251689-a1d85909bc23"),
  street: img("photo-1778856920032-328a86d21a22"),
  window: img("photo-1769981271695-bb3d766ee419"),
};
...
export const RETAIL_FASHION_DEMOS: RetailFashionConfig[] = [
  ...
  },
  {
    ...
    heroImage: img("photo-1753161028168-ecb995559560", 2000),
    collectionTitle: "Colección Primavera",
    collectionSubtitle: "Essentials de autor",
    products: [
      { id: 1, name: "Trench Camel", price: "Consultar", image: img("photo-1773864931052-ea56474bcc84") },
      { id: 2, name: "Vestido Lino", price: "Consultar", image: img("photo-1613909671501-f9678ffc1d33") },
      { id: 3, name: "Set Sastrero", price: "Consultar", image: img("photo-1753161021164-b075e15e91b3") },
      { id: 4, name: "Abrigo Lana", price: "Consultar", image: img("photo-1762796876250-2ea2c4078f52") },
    ],
    instagramHandle: "maisonelle.boutique",
    instagramUrl: "https://www.instagram.com/",
    instagramFeed: [
      img("photo-1778856920032-328a86d21a22"),
      img("photo-1769981271695-bb3d766ee419"),
      img("photo-1571924848943-25c2c95bbb4b"),
      img("photo-1758274251689-a1d85909bc23"),
    ],
  ...
  },
  {
    ...
    heroImage: img("photo-1753161021164-b075e15e91b3", 2000),
    collectionTitle: "Capsule Noire",
    collectionSubtitle: "Monocromo premium",
    products: [
      { id: 1, name: "Blazer Midnight", price: "Consultar", image: img("photo-1605289355680-75fb41239154") },
      { id: 2, name: "Vestido Satén", price: "Consultar", image: img("photo-1571924849183-a68a3879348d") },
      { id: 3, name: "Capa Cuero", price: "Consultar", image: img("photo-1636023329674-7b7ea3c663e9") },
      { id: 4, name: "Pantalón Wide", price: "Consultar", image: img("photo-1774571872279-59580ca46d45") },
    ],
    instagramHandle: "atelier.noir.store",
    instagramUrl: "https://www.instagram.com/",
    instagramFeed: [
      img("photo-1659522761084-79196b64abe4"),
      img("photo-1603122630570-7fd434d470d0"),
      img("photo-1769981271695-bb3d766ee419"),
      img("photo-1778856920032-328a86d21a22"),
    ],
  ...
  },
  {
    ...
    heroTitle: "Bajo la",
    heroHighlight: "Luna.",
    heroImage: img("photo-1571924848943-25c2c95bbb4b", 2000),
    collectionTitle: "Noche de Gala",
    collectionSubtitle: "Brillos y seda",
    products: [
      { id: 1, name: "Vestido Luna", price: "Consultar", image: img("photo-1778856920032-328a86d21a22") },
      { id: 2, name: "Top Brillo", price: "Consultar", image: img("photo-1571924849183-a68a3879348d") },
      { id: 3, name: "Falda Plisada", price: "Consultar", image: img("photo-1774571872279-59580ca46d45") },
      { id: 4, name: "Kimono Seda", price: "Consultar", image: img("photo-1762796876250-2ea2c4078f52") },
    ],
    instagramHandle: "luna.boutique.st",
    instagramUrl: "https://www.instagram.com/",
    instagramFeed: [
      img("photo-1758274251689-a1d85909bc23"),
      img("photo-1753161021164-b075e15e91b3"),
      img("photo-1769981271695-bb3d766ee419"),
      img("photo-1659522761084-79196b64abe4"),
    ],
  ...
  },
  {
    ...
    heroImage: img("photo-1613909671501-f9678ffc1d33", 2000),
    collectionTitle: "Archivo Seda",
    collectionSubtitle: "Piezas únicas",
    products: [
      { id: 1, name: "Blusa Seda", price: "Consultar", image: img("photo-1762796876250-2ea2c4078f52") },
      { id: 2, name: "Palazzo Silk", price: "Consultar", image: img("photo-1778856920032-328a86d21a22") },
      { id: 3, name: "Scarf Print", price: "Consultar", image: img("photo-1571924849183-a68a3879348d") },
      { id: 4, name: "Camisa Fluida", price: "Consultar", image: img("photo-1773864931052-ea56474bcc84") },
    ],
    ...
    instagramFeed: [
      ...
      img("photo-1778856920032-328a86d21a22"),
      img("photo-1769981271695-bb3d766ee419"),
      img("photo-1636023329674-7b7ea3c663e9"),
    ],
  ...
  },
  {
    ...
    heroImage: img("photo-1774571872279-59580ca46d45", 2000),
    collectionTitle: "Studio Collection",
    collectionSubtitle: "Diseño independiente",
    products: [
      { id: 1, name: "Chaqueta Patch", price: "Consultar", image: img("photo-1636023329674-7b7ea3c663e9") },
      { id: 2, name: "Denim Nova", price: "Consultar", image: img("photo-1605289355680-75fb41239154") },
      { id: 3, name: "Top Crop", price: "Consultar", image: img("photo-1778856920032-328a86d21a22") },
      { id: 4, name: "Cargo Studio", price: "Consultar", image: img("photo-1753161021164-b075e15e91b3") },
    ],
  ...
  },
  {
    ...
    heroTitle: "Líneas",
    heroHighlight: "Puras.",
    heroImage: img("photo-1762796876250-2ea2c4078f52", 2000),
    collectionTitle: "Essentials",
    collectionSubtitle: "Minimal & clean",
    products: [
      { id: 1, name: "Coat Sand", price: "Consultar", image: img("photo-1773864931052-ea56474bcc84") },
      { id: 2, name: "Knit Beige", price: "Consultar", image: img("photo-1613909671501-f9678ffc1d33") },
      { id: 3, name: "Pant Wide", price: "Consultar", image: img("photo-1753161028168-ecb995559560") },
      { id: 4, name: "Shirt White", price: "Consultar", image: img("photo-1605289355680-75fb41239154") },
    ],
    instagramHandle: "linnea.store",
    instagramUrl: "https://www.instagram.com/",
    instagramFeed: [
      img("photo-1769981271695-bb3d766ee419"),
      img("photo-1762796876250-2ea2c4078f52"),
      img("photo-1778856920032-328a86d21a22"),
      img("photo-1753161021164-b075e15e91b3"),
    ],
  ...
  },
  {
    ...
    heroImage: img("photo-1778856920032-328a86d21a22", 2000),
    collectionTitle: "Rosé Edit",
    collectionSubtitle: "Tonos suaves",
    products: [
      { id: 1, name: "Dress Blush", price: "Consultar", image: img("photo-1571924849183-a68a3879348d") },
      { id: 2, name: "Set Rosé", price: "Consultar", image: img("photo-1613909671501-f9678ffc1d33") },
      { id: 3, name: "Bolero Knit", price: "Consultar", image: img("photo-1753161028168-ecb995559560") },
      { id: 4, name: "Skirt Pleat", price: "Consultar", image: img("photo-1762796876250-2ea2c4078f52") },
    ],
  ...
  },
  {
    ...
    products: [
      { id: 1, name: "Hoodie Premium", price: "Consultar", image: img("photo-1636023329674-7b7ea3c663e9") },
      { id: 2, name: "Jacket Puffer", price: "Consultar", image: img("photo-1605289355680-75fb41239154") },
      { id: 3, name: "Set Urban", price: "Consultar", image: img("photo-1753161021164-b075e15e91b3") },
      { id: 4, name: "Cap Lab", price: "Consultar", image: img("photo-1774571872279-59580ca46d45") },
    ],
  ...
  },
  {
    ...
    heroTitle: "Imagen",
    heroHighlight: "Total.",
    heroImage: img("photo-1769981271695-bb3d766ee419", 2000),
    collectionTitle: "Editorial",
    collectionSubtitle: "Estudio & retail",
    products: [
      { id: 1, name: "Look Editorial 01", price: "Consultar", image: img("photo-1758274251689-a1d85909bc23") },
      { id: 2, name: "Look Editorial 02", price: "Consultar", image: img("photo-1571924848943-25c2c95bbb4b") },
      { id: 3, name: "Look Editorial 03", price: "Consultar", image: img("photo-1778856920032-328a86d21a22") },
      { id: 4, name: "Look Editorial 04", price: "Consultar", image: img("photo-1571924849183-a68a3879348d") },
    ],
