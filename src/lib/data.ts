...
export const websiteModels = [
  {
    id: "basico",
    name: "Plan básico",
    subtitle: "Presencia sólida en internet",
    priceNote: "ARS 75.000",
    features: [
      ...
      "Asesoría para dominio, hosting y puesta online",
    ],
    idealFor: "Profesionales, comercios locales y marcas que necesitan empezar ya.",
  },
  {
    id: "completo",
    name: "Plan completo",
    subtitle: "Más páginas, conversión y control",
    priceNote: "ARS 150.000",
    features: [
      "Todo lo del plan básico + más secciones o páginas internas",
      "Blog o noticias a pedido, multi-idioma opcional",
      "SEO técnico ampliado, analytics y objetivos de conversión",
      "CMS o panel liviano para que actualices textos e imágenes",
    ],
    idealFor: "Pymes y estudios que ya venden y quieren escalar la web.",
  },
  {
    id: "personalizado",
    name: "Diseño personalizado",
    subtitle: "Estética y experiencia a medida",
    priceNote: "ARS 300.000",
    features: [
      "UI/UX propia (no genérica): tipografía, color, componentes exclusivos",
      "Animaciones, microinteracciones y detalle visual premium",
      "Mayor volumen de pantallas y contenido estructurado",
      "Iteraciones de diseño y afinado previo a salida a producción",
    ],
    idealFor: "Marcas que priorizan diferenciación y una experiencia memorable.",
  },
  {
    id: "desarrollo",
    name: "Más desarrollo",
    subtitle: "Sistemas, tiendas y proyectos complejos",
    priceNote: "Cotizar",
    features: [
      "E-commerce, carritos, pagos (Mercado Pago, Stripe u otros)",
      "Dashboards, turneros, APIs, roles de usuario y bases de datos",
      "Integraciones: facturación, CRM, envíos, ERP y más",
      "Documentación, entregas por etapas y mantenimiento acordado",
    ],
    idealFor: "Empresas que necesitan producto digital, no solo una web estática.",
  },
];
