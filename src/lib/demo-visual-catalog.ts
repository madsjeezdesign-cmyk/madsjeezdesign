...
export const DEMO_IMAGES: Record<string, DemoImageSet> = {
  ...
  granja: {
    ...
    d: id("photo-1500595046743-cd271d1d4b0b"),
    e: id("photo-1500595046743-cd271d1d4b0c"),
  },
  computacion: {
    cover: id("photo-1534723328310-e82dad3ee18b"),
    a: id("photo-1556740738-3096d1e22416"),
    b: id("photo-1556742044-36c9c39b3aaa"),
    c: id("photo-1556742396-56c4db640b8a"),
    d: id("photo-1556742400-5d88e1c0f0e8"),
    e: id("photo-1556742500-5d88e1c0f0e9"),
  },
  ropa: {
    cover: id("photo-1551288049-bebda4e38f71"),
    a: id("photo-1552664730-d307ca884978"),
    b: id("photo-1553877522-43269d4ea984"),
    c: id("photo-1556761175-5973dc0f32e7"),
  ...
  barberia: {
    ...
    b: id("photo-1581092918056-0c4c3acd3780"),
    c: id("photo-1581094794329-c8112a89af12"),
    d: id("photo-1581094794329-c8112a89af15"),
    e: id("photo-1581094794329-c8112a89af16"),
  },
  marketing: {
    cover: id("photo-1621905251189-08f45a6c2884"),
    a: id("photo-1621905252507-b35492cc74b4"),
    b: id("photo-1621905252472-474af0f74510"),
    c: id("photo-1621905252507-b35492cc74b8"),
    d: id("photo-1621905252507-b35492cc74b9"),
    e: id("photo-1621905252507-b35492cc74ba"),
  },
  imprenta: {
    cover: id("photo-1621905251189-08f45a6c2885"),
    a: id("photo-1621905251189-08f45a6c2886"),
    b: id("photo-1621905251189-08f45a6c2887"),
    c: id("photo-1621905251189-08f45a6c2888"),
    d: id("photo-1621905251189-08f45a6c2889"),
    e: id("photo-1621905251189-08f45a6c288a"),
  },
  motores: {
    cover: id("photo-1504307651254-35680f356dfd"),
    a: id("photo-1503387762-592deb58ef4e"),
    b: id("photo-1504309092620-4dacdaf43f7f"),
    c: id("photo-1503389150091-9c1f0e6e9c01"),
    d: id("photo-1503389150091-9c1f0e6e9c02"),
    e: id("photo-1503389150091-9c1f0e6e9c03"),
  },
  gasista: {
    cover: id("photo-1486406146926-c627a92ad1ab"),
    a: id("photo-1487958449943-242f694e8e43"),
    b: id("photo-1497366754035-f200968a6e72"),
    c: id("photo-1503389150091-9c1f0e6e9c04"),
    d: id("photo-1503389150091-9c1f0e6e9c05"),
    e: id("photo-1503389150091-9c1f0e6e9c06"),
  },
  electricista: {
    cover: id("photo-1503389150091-9c1f0e6e9c07"),
    a: id("photo-1503389150091-9c1f0e6e9c08"),
    b: id("photo-1503389150091-9c1f0e6e9c09"),
    c: id("photo-1503389150091-9c1f0e6e9c0a"),
    d: id("photo-1503389150091-9c1f0e6e9c0b"),
    e: id("photo-1503389150091-9c1f0e6e9c0c"),
  },
  albanil: {
    cover: id("photo-1503389150091-9c1f0e6e9c0d"),
    a: id("photo-1503389150091-9c1f0e6e9c0e"),
    b: id("photo-1503389150091-9c1f0e6e9c0f"),
    c: id("photo-1503389150091-9c1f0e6e9c10"),
    d: id("photo-1503389150091-9c1f0e6e9c11"),
    e: id("photo-1503389150091-9c1f0e6e9c12"),
  },
  arquitectos: {
    cover: id("photo-1503389150091-9c1f0e6e9c13"),
    a: id("photo-1503389150091-9c1f0e6e9c14"),
    b: id("photo-1503389150091-9c1f0e6e9c15"),
    c: id("photo-1503389150091-9c1f0e6e9c16"),
    d: id("photo-1503389150091-9c1f0e6e9c17"),
    e: id("photo-1503389150091-9c1f0e6e9c18"),
  },
};
...
export const DEMO_LEAD_COPY: Record<string, { kicker: string; title: string; sub: string }> = {
  ...
  "taller-motos": {
    ...
    sub: "Pedí presupuesto o turno online en minutos.",
  },
  celulares: {
