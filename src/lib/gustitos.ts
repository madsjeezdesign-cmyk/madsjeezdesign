...
export const GUSTITOS_CONFIG = {
  ...
  heroImage: img("photo-1568901348415-4e8a0d0a2e2e", 2200),
  mapsEmbedUrl:
...
export const GUSTITOS_PRODUCTS: GustitosProduct[] = [
  {
    ...
    price: 10900,
    image: img("photo-1568901348415-4e8a0d0a2e2e"),
    imageHover: img("photo-1550547660-22a4d7d4e4e4"),
    badge: "Best seller",
    featured: "large",
  },
  {
    ...
    imageHover: img("photo-1568901348415-4e8a0d0a2e2e"),
    badge: "Explosiva",
    spicy: true,
    featured: "wide",
  },
  {
    ...
    price: 16800,
    image: img("photo-1550547660-22a4d7d4e4e4"),
  ...
  },
  {
    ...
    price: 19900,
    image: img("photo-1572802419224-296b0aeee0df"),
    imageHover: img("photo-1568901348415-4e8a0d0a2e2e"),
    badge: "Promo",
  },
  {
    ...
    price: 7200,
    image: img("photo-1573080496219-a68334a4fbb9"),
    imageHover: img("photo-1630384086590-0d726d64dcdc"),
  },
  {
    id: 6,
    ...
    price: 7800,
    image: img("photo-1630384086590-0d726d64dcdc"),
    imageHover: img("photo-1573080496219-a68334a4fbb9"),
  },
  {
    id: 7,
    ...
    price: 5900,
    image: img("photo-1572490122747-3969b75c99bf"),
    imageHover: img("photo-1622484210458-90983b4d8c6a"),
  },
  {
    id: 8,
    ...
    price: 3200,
    image: img("photo-1622484210458-90983b4d8c6a"),
    imageHover: img("photo-1572490122747-3969b75c99bf"),
  },
  {
    id: 9,
    name: "Bacon Volcano",
